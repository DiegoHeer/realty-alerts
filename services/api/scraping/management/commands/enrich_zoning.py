...
class Command(BaseCommand):
    help = "Dispatch zoning enrichment for residences missing this data"
    ...
    def handle(self, **options):
        qs = Residence.objects.filter(
            ...
            zoning_fetched_at__isnull=True,
        )
        total = qs.count()
        ...
        logger.info("Dispatched zoning enrichment for {} of {} residence(s)", dispatched, total)
