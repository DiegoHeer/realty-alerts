...
class Command(BaseCommand):
    help = "Dispatch soil status enrichment for residences missing this data"
    ...
    def handle(self, **options):
        ...
        logger.info("Dispatched soil status enrichment for {} of {} residence(s)", dispatched, total)
